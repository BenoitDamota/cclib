...
class ccData(object):
    ...
    _attributes = {
       ...
       "nuclearspins":     Attribute(numpy.ndarray,    'nuclearspins',                'atoms'),
       "atomzeff":         Attribute(numpy.ndarray,    'atomzeff',                    'atoms'),
       "nuclearqmom":      Attribute(numpy.ndarray,    'nuclearqmom',                 'atoms'),
       "nucleargfactors":  Attribute(numpy.ndarray,    'nucleargfactors',             'atoms'),
